...
{
	$tambahan .= nbs(2)."<a href='".site_url('pendaftaran_pasien/tambah')."' class='btn btn-default' id='TambahPendaftaran'><i class='fa fa-plus fa-fw'></i> Tambah Pendaftaran</a>";
...
<script type="text/javascript" language="javascript" >
	$(document).ready(function() {
		var dataTable = $('#my-grid').DataTable( {
			...
			"ajax":{
				url :"<?php echo site_url('pendaftaran_pasien/pendaftaran_json'); ?>",
				type: "post",
				error: function(){ 
					$(".my-grid-error").html("");

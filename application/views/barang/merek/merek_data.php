...
<div class="container">
	<div class="panel panel-default">
		<div class="panel-body">
			<h5><i class='fa fa-cube fa-fw'></i> Barang <i class='fa fa-angle-right fa-fw'></i> List Satuan</h5>
			<hr />
...
{
	$tambahan .= nbs(2)."<a href='".site_url('barang/tambah-merek')."' class='btn btn-default' id='TambahMerek'><i class='fa fa-plus fa-fw'></i> Tambah Satuan</a>";

...
<div class="container">
	<div class="panel panel-default">
		<div class="panel-body">
			<h5><i class='fa fa-file-text-o fa-fw'></i> Laporan Obat Masuk</h5>
			<hr />

			<?php echo form_open('laporan_obat_masuk', array('id' => 'FormLaporan')); ?>
			<div class="row">
				<div class="col-sm-5">
...
$(document).ready(function(){
	$('#FormLaporan').submit(function(e){
		...
		{
			var URL = "<?php echo site_url('laporan_obat_masuk/penjualan_obat_masuk'); ?>/" + TanggalDari + "/" + TanggalSampai;
			$('#result').load(URL);
		}
	});
});
